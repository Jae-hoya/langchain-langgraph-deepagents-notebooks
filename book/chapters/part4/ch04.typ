...
#align(center)[#image("../../assets/diagrams/png/backend_abstraction.png", width: 70%)]
...
#align(center)[#image("../../assets/diagrams/png/composite_backend.png", width: 70%)]
...
#align(center)[#image("../../assets/diagrams/png/backend_decision_tree.png", width: 70%)]
